...
const CardService = ({ icon: Icon, title, content }) => (
  ...
  >
    <div className="absolute left-1/2 top-0 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-tr from-orange-500 via-red-500 to-orange-600 shadow-lg rounded-full flex justify-center items-center z-[3]">
      {Icon}
    </div>
